...
buildings = STRUCT([floor0,floor1,pillars,floor2,floor3,floor4,estwall,estwindow,estDoppia,T([1])([-5])(estDoppia),northwall,southwall,westwall,northwindows,estwindows,T([2,3])([0.4,11])(southwindows),T([2,3])([0.4,21])(southwindows),T([1,2])([21,20])(ramp),T([1,2,3])([6,20,10])(ramp),T([1,2,3])([21,20,20])(ramp)]);
VIEW(buildings)
