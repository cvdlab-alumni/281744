...
##esercizio5
#fondo
sup1 =R([2,3])(PI/2)(R([1,2])(-PI)( MAP(BEZIER(S2)([BEZIER(S1)(p5),BEZIER(S1)(p6)]))(domain)))

#superfici laterali
sup2 = MAP(BEZIER(S2)([BEZIER(S1)(pl3),BEZIER(S1)(pl4)]))(domain)
sup3 =  MAP(BEZIER(S2)([BEZIER(S1)(pl4),BEZIER(S1)(pl3)]))(domain)
sup4 = MAP(BEZIER(S2)([BEZIER(S1)(pl6),BEZIER(S1)(pl7)]))(domain)
sup5 = MAP(BEZIER(S2)([BEZIER(S1)(pl7),BEZIER(S1)(pl6)]))(domain)

es5 = STRUCT([es4,T([1,2,3])([12.1,-1,-1])(S([1])([3.8])(sup1)),T(2)(2)(sup2),T(2)(-1)(sup3),T(2)(2)(sup4),T(2)(-1)(sup5)])
